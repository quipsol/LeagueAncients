...
/// <summary>
/// Gain Strength and Dexterity at low health
/// </summary>
[Pool(typeof(EventRelicPool))]
public class Nadir : LeagueAncientsRelicModel
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [new PowerVar<StrengthPower>(1), new PowerVar<DexterityPower>(3), 
                ...
                .. new CalculatedRelicVar(THRESHOLD_CALC)
                            .WithMultiplier(relic => ((Nadir?)relic)?.ThresholdCalculated ?? 0)
    ...
    public override async Task AfterRoomEntered(AbstractRoom room)
    {
        ...
        Flash();
        await PowerCmd.Apply<NadirPower>(new ThrowingPlayerChoiceContext(), Owner.Creature, 1, Owner.Creature, null);
        _active = true;
    }

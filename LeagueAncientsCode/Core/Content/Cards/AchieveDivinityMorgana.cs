...
public class AchieveDivinityMorgana() : LeagueAncientsCardModel(1, CardType.Skill, CardRarity.Ancient, TargetType.Self)
{
    ...
    {
        foreach (var allCard in Owner.PlayerCombatState?.AllCards.Where(c => c.Type is CardType.Skill || (IsUpgraded && c.Type is CardType.Power)) ?? [])
        {
